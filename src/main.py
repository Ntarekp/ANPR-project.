...
def main():
    ...
    while True:
        ...
        message = "Camera -> Detection -> Alignment -> OCR"
        ...
        cv2.putText(vis, "Press q to quit", (20, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
